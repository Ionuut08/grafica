...
void Display8() {
    ...
    glVertex2f(0.35,0.62); // 1
    glVertex2f(0.7,0.0); // 2
    glVertex2f(0.35,-0.62); // 3
    glVertex2f(-0.35,-0.62); // 4
    glVertex2f(-0.7,0.0); // 5
    glVertex2f(-0.35,0.62); // 6
    glEnd();

    glBegin(GL_POLYGON);
    glColor3f(1,0.1,0.1);

    glVertex2f(0.25,0.45); // 1
    glVertex2f(0.5,0.0); // 2
    glVertex2f(0.25,-0.45); // 3
    glVertex2f(-0.25,-0.45); // 4
    glVertex2f(-0.5,0.0); // 5
    glVertex2f(-0.25,0.45); // 6
    glEnd();

    glBegin(GL_POLYGON);
    glColor3f(1,1,1);

    glVertex2f(0.23,0.43); // 1
    glVertex2f(0.48,0.0); // 2
    glVertex2f(0.23,-0.43); // 3
    glVertex2f(-0.23,-0.43); // 4
    glVertex2f(-0.48,0.0); // 5
    glVertex2f(-0.23,0.43); // 6
    glEnd();
}
